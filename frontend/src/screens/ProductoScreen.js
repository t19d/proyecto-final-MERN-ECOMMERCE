                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-6 col-sm-12 col-xs-12">
                                ...
                                {/*
                                    ...
                                    <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                                        ...
                                        <div className="carousel-inner conjuntoImagenesProducto row form-group">
                            ...
                            <div className="col-md-6 col-sm-12 col-xs-12">
                                ...
                                {getStock(producto) > 0 ?
                                    <div className="contenedorBtnCarrito text-center">
                                        <button onClick={handleAnhadirCarrito} type="button" className="btn botonAnhadirCarrito text-center">
                                            <span>
